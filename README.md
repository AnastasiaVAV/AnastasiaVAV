...
- [Список задач](https://github.com/AnastasiaVAV/Task-Manager) – приложение с аутентификацией и авторизацией, CRUD операциями с задачами, бэкендом: TypeScript, React, Supabase, Vite
